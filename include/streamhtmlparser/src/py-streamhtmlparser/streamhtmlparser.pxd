# Generated using:
#
# h2xml -I.. -I/usr/include streamhtmlparser/htmlparser.h -o htmlparser.xml
# xml2cython.py -l htmlparser htmlparser.h htmlparser.xml > ../py-streamhtmlparser/streamhtmlparser.pxd
#
# Manual fixes of constant sized char arrays in structures and forward struct
# definitions.
